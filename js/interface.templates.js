...
this["Fliplet"]["Widget"]["Templates"]["templates.accessRule"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<tr data-rule-index=\""
    ...
    + "</td>\r\n  <td class=\"align-baseline\">"
    + ((stack1 = ((helper = (helper = helpers.include  || (depth0 != null ? depth0.include : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"exclude","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</td>\r\n  <td class=\"align-baseline\">"
