...
var $trashSources = $('#trash-sources > tbody');
...
function getTrashedDataSources() {
  Fliplet.API.request({
...
function sortDataSources(key, order, data) {
  ...
  if ((copyData.context === 'app-overlay' || copyData.appId) && isShowingAll && !isShowingTrash) {
